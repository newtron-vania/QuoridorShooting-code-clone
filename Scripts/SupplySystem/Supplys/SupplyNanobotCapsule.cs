...
public class SupplyNanobotCapsule : BaseSupply
{
    ...
    public override void UseSupply()
    {
        ...
        if (EffectDataList[1].Get<int>("Duration") != 0)
        {
            SupplyManager.Instance._saveDurationSupply.Add(this);
        }
        _saveTurn = GameManager.Instance.Turn;
        SupplyBaseCharacter.characterStat.Hp += EffectDataList[0].Get<int>("DamageValue");
        SupplyBaseCharacter.characterStat.Atk += EffectDataList[1].Get<int>("DamageValue");
