...
{
    BaseCharacter SpawnCharacter(CharacterData characterData, CharacterController controller);
}

public class PlayerCharacterSpawner : ICharacterSpawner
{
    private int count = 0;
    public BaseCharacter SpawnCharacter(CharacterData characterData, CharacterController controller)
    {
